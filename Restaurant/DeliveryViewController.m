...
//    {
        ...
        if ([self checkForLiteracy])
        {
            if ([self checkForNumberCount]) {
                ...
                NSMutableString *order = [NSMutableString stringWithString: @"http://matrix-soft.org/addon_domains_folder/test8/root/Customer_Scripts/makeOrder.php?tag=order&DBid=13&UUID="];
